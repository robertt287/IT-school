...
public class DateTimeProblem {
    ...
    public static void main(String[] args) {
        ...
        LocalDate firstMonday = firstDayOfNextYear.getDayOfWeek() == DayOfWeek.MONDAY ? firstDayOfNextYear : firstDayOfNextYear.with(TemporalAdjusters.next(DayOfWeek.MONDAY));
